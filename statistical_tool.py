...
class StatisticalTool:
    def __init__(self, dataset_path, system_names, max_workloads=13):
        ...
        self.output_path = "landscape_tables"
    ...
    def basin_vs_perf_spearman(max_workloads=13):
        ...
        csv_files = {
            ...
            "batlik": "landscape_results/batlik/landscape_metrics/BoA/batlik_spearman_cor_basin_vs_perf.csv",
...
if __name__ == "__main__":
    ...
    system_names = ['lrzip', 'xz', 'z3', 'dconvert', 'batlik', 'kanzi', 'x264', 'h2', 'jump3r']
